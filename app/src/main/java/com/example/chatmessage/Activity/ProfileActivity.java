...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgressDialog.setTitle("Kết nối Server");
        mProgressDialog.setMessage("Vui lòng đợi trong khi kết nối");
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if(dataSnapshot.hasChild(user_id)){
                            ...
                            if(req_type.equals("received")){
                                ...
                                mProfileSendReqBtn.setText("Xát nhận");
                                ...
                                mProfileSendReqBtn.setText("Xóa");
                    ...
                    mRootRef.updateChildren(requestMap, new CompletionListener() {
                        ...
                        public void onComplete(@Nullable DatabaseError databaseError, @NonNull DatabaseReference databaseReference) {
                            ...
                            if(databaseError != null){
                                ...
                                Toast.makeText(ProfileActivity.this,"Xảy ra lỗi trong khi gửi dữ liệu", Toast.LENGTH_SHORT).show();
                            }
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            mFriendReqDatabase.child(user_id).child(mCurrentUser.getUid()).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    mProfileSendReqBtn.setEnabled(true);
                                    mCurrent_state = "not_friends";
                                    mProfileSendReqBtn.setText("Kết bạn");
