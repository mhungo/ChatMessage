...
import com.example.chatmessage.GetTimeAgo;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private CircleImageView custombar_image_chat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        custombar_image_chat = findViewById(R.id.custom_bar_image);
        ...
        custombar_image_chat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
