    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                mProgressDialog.setMessage("Vui lòng đợi trong lúc tải ảnh lên.");
                                                    ...
                                                    mUserDatabase.updateChildren(update_hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            ...
                                                            if (task.isSuccessful()) {
                                                                ...
                                                                Toast.makeText(SettingsActivity.this, "Tải thành công", Toast.LENGTH_SHORT).show();

                                                            } else {
                                                                mProgressDialog.dismiss();
                                                                Toast.makeText(SettingsActivity.this, "Lỗi không tải được ảnh", Toast.LENGTH_SHORT).show();
                                                            }
