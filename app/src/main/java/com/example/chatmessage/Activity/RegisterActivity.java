        ...
        mCreateBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(display_name) || !TextUtils.isEmpty(email) || !TextUtils.isEmpty(password) ){
                    ...
                    mRegProgress.setMessage("Vui lòng đợi trong lúc tạo tài khoản !");
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()){
                                ...
                                try{
                                    ...
                                    userMap.put("status","Xin chào, tôi đang sử dụng chat mesage");
                                ...
                                mRegProgress.hide();
                                Toast.makeText(RegisterActivity.this,"Không thể đăng nhập, Thử lại sau", Toast.LENGTH_LONG).show();
                            }
