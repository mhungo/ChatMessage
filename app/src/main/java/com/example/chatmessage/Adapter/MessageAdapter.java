...
import com.example.chatmessage.Activity.ChatActivity;
import com.example.chatmessage.Model.Messages;
...
//        public ImageView messageImage;
        ...
        public CircleImageView profileImageChat;
    ...
    public void onBindViewHolder(final MessageViewHolder viewHolder, int position) {
        ...
        mUserDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                //Picasso.with(viewHolder.profileImageChat.getContext()).load(image).placeholder(R.drawable.profile_pic).into(viewHolder.profileImageChat);
